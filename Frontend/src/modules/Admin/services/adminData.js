  ...
  headline: [
    {
      ...
      trend: { direction: 'up', value: '3.8%', message: 'growth vs last 30 days' },
    },
    {
      id: 'vendors',
      ...
      trend: { direction: 'up', value: '6 new', message: 'applications approved' },
    },
    {
      id: 'orders',
      title: 'Orders (User + Vendor)',
      value: '3,140',
      subtitle: '78 escalations in queue',
      trend: { direction: 'down', value: '1.2%', message: 'vs last week' },
    },
    {
      id: 'revenue',
      title: 'Gross Revenue',
      value: '₹8.4 Cr',
      subtitle: 'Net margin 21%',
      trend: { direction: 'up', value: '₹1.2 Cr', message: 'collected this week' },
    },
  ],
  payables: {
    advance: '₹2.6 Cr',
...
export const analyticsSummary = {
  ...
  timeline: [
    {
      id: 'event-1',
      title: 'Vendor credit review completed',
      timestamp: 'Today, 09:30',
      description: '14 vendors moved back to On Track status after repayment verification.',
      status: 'completed',
    },
    {
      id: 'event-2',
      title: 'Monthly seller leaderboard published',
      timestamp: 'Yesterday, 18:05',
      description: 'Leaderboard shared with incentives and rewards for top performers.',
      status: 'completed',
    },
    {
      id: 'event-3',
      title: 'Logistics delay alert',
      timestamp: 'Yesterday, 11:40',
      description: 'Western region facing 18h delay due to local strikes. Contingency plan activated.',
      status: 'pending',
    },
  ],
}
